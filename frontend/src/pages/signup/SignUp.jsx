    ...
    <div className='flex flex-col items-center justify-center min-w-96 mx-auto'>
      <div className='w-full p-6 bg-white-400 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-80 border border-gray-100'>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <Link to="/login" className='text-sm hover:underline text-white hover:text-blue-500 mt-2 inline-block'>
            Already have an account?
          </Link>

          <div>
            <button className='btn bg-blue-500 btn-block btn-sm mt-2 border border-slate-700' disabled={loading}>
